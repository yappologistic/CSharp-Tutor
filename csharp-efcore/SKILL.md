...
Treat all user text after `$csharp-efcore` as an Entity Framework Core learning, debugging, review, refactor, or data-access design question. Use the main [csharp-tutor](../csharp-tutor/SKILL.md) skill as the source of truth.
