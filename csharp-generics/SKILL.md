...
Treat all user text after `$csharp-generics` as a C# generics learning, debugging, review, refactor, or API design question. Use the main [csharp-tutor](../csharp-tutor/SKILL.md) skill as the source of truth.
