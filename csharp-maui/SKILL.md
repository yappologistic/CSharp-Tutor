---
name: csharp-maui
description: Teach and review .NET MAUI applications in C#. Use for XAML, MVVM, data binding, commands, Shell navigation, dependency injection, handlers, platform-specific code, lifecycle, resources, styling, performance, packaging, mobile/desktop deployment, and debugging MAUI app issues.
metadata:
...
Treat all user text after `$csharp-maui` as a .NET MAUI learning, debugging, review, refactor, or architecture question. Use the main [csharp-tutor](../csharp-tutor/SKILL.md) skill as the source of truth.
