...
Treat all user text after `$csharp-interview` as a C# or .NET interview-prep request. Use the main [csharp-tutor](../csharp-tutor/SKILL.md) skill as the source of truth.
